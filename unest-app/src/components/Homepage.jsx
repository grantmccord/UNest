        ...
        <header>
          <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
            ...
            <div className="flex items-center space-x-5 mt-[14px]">
              <button onClick={() => setMapActive(!mapActive)} class={!mapActive ? "bg-red-400 hover:bg-red-500 text-gray-800 py-2 px-4 rounded-lg inline-flex items-center" : "bg-yellow-200 hover:bg-yellow-300 text-gray-800 py-2 px-4 rounded-lg inline-flex items-center"} >
                <div>Map</div>
